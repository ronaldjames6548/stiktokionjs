                        ...
                        <div className="project-dec">
                                        ...
                                        <div className="col-xl-6 col-md-6">
                                            <div className="image">
                                                <PhotoView src="/img/all-img/blog-4.jpg" >
                                                    <Image width={416} height={377} sizes='100vw' src="/img/all-img/blog-4.jpg" alt="image" className="popup-img" />
                                                </PhotoView>
                                            </div>
                                        </div>
                                        <div className="col-xl-6 col-md-6">
                                            <div className="image">
                                                <PhotoView src="/img/all-img/blog-5.jpg">
                                                    <Image width={416} height={377} sizes='100vw' src="/img/all-img/blog-5.jpg" alt="image" className="popup-img" />
                                                </PhotoView>
                                            </div>
                                        </div>
                                    </PhotoProvider>
                            ...
                            <a onClick={(e) => { setOpen(true), e.preventDefault() }} className="popup-youtube" href="#">
                                <div className="image-video">
                                    <Image width={856} height={467} sizes='100vw' src="/img/all-img/pd-1.jpg" alt="image" />
